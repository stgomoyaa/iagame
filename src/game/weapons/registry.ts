...
import { seedWeaponOffsets, type Transform, type WeaponIndexEntry } from '@/game/weapons/seed'

export type { Transform, WeaponIndexEntry } from '@/game/weapons/seed'

const WEAPON_INDEX: WeaponIndexEntry[] = rawIndex as WeaponIndexEntry[]
